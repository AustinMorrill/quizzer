		...
		if(currentQuestion.answerArray.length === 2){
			setCurrentQuestionArray(
				...
				<div className='flex flex-col'>
					<Fade>
					<button 
						className='flex-1 my-2 bg-tc-lighter text-xl hover:bg-tc-light text-gray-800 text-bold text-xl font-semibold py-2 px-4 border border-gray-400 rounded shadow-md transition-all transition-duration-500 outline-none'
	...
	return (
		<Fade>
			...
			>
				<Fade spy={finished}>
					<div
						className='mt-8 flex flex-col justify-start w-11/12 sm:w-9/12 md:w-8/12 lg:w-7/12 border-tc-darker p-8 border-t-8 bg-white mb-6 rounded-lg shadow-lg transition-all transition-duration-500 static'
						style={{ height: "auto" }}
					>
						{!finished ? (
							<Fade>
								<>
									<Fade>
										<Fade spy={currentQuestion.question}>
											<div className='flex flex-col text-2xl select-none'>
											...
											{!answered ? (
												...
												<Fade duration={400}>
													<div className='flex flex-col justify-center items-center'>
														<Tada>
															<div className='bg-tc-light my-2 text-center w-7/12 text-black text-2xl font-bold border-t-4 border-tc-darkest rounded px-4 py-2 shadow-md'>
																Correct!
															</div>
														</Tada>
